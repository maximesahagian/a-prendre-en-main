                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="text" class="text-input col-md-12" placeholder="Texte de l'actualité" id="" cols="30" rows="10"></textarea>
                        </div>
                        ...
                        <button class="validate btn btn-success">Ajouter</button>
                    </div>
                </div>
            </div>
        </div>
